...
export const services: Record<ServiceSlug, ServiceSummary> = {
  "software-a-medida": {
    ...
    relatedPosts: ["software-medida-vs-saas-guia-pymes", "como-elegir-empresa-desarrollo-software-espana"],
  ...
  "web-a-medida": {
    ...
    relatedPosts: ["desarrollo-web-a-medida-vs-wordpress-cuando-dar-el-salto", "digitalizacion-pymes-espana-guia-2026"],
  ...
  "crm-intranet-a-medida": {
    ...
    relatedPosts: ["crm-a-medida-vs-hubspot-salesforce-pymes", "ecosistemas-software-conectados-erp-crm-pymes"],
