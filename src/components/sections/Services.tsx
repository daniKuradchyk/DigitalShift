    ...
    <section id="servicios" aria-labelledby="services-title" className="relative scroll-mt-28 py-20 lg:py-28">
      <Container>
        <div className="surface-shell relative overflow-hidden rounded-[2rem] p-6 sm:p-8 lg:p-10">
          <div
            aria-hidden
            className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(167,139,250,0.08),transparent_32%),radial-gradient(circle_at_bottom_right,rgba(192,132,252,0.06),transparent_36%)]"
          />
          ...
          <div className="relative grid gap-10 lg:grid-cols-[1fr_320px] lg:items-start">
            ...
            <div className="surface-panel relative overflow-hidden rounded-3xl p-6">
              <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-violet-400">Como leer esta capa</p>
              ...
              <div className="mt-5 border-t border-violet-500/8 pt-5">
                <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-violet-400">Jerarquia</p>
                <p className="mt-2 text-sm leading-relaxed" style={{ color: "var(--text-muted)" }}>
                  La home resume. El hub <strong className="font-semibold" style={{ color: "var(--text-primary)" }}>/servicios</strong> reparte
