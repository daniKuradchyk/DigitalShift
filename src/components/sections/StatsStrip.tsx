...
export default function StatsStrip() {
  return (
    <section className="relative border-y border-brand-500/8 bg-brand-500/[0.015]">
      <Container>
        <div className="grid gap-0 sm:grid-cols-2 xl:grid-cols-4">
          {homeStats.map((item) => (
            <div
              key={item.label}
              className="border-b border-brand-500/8 px-5 py-6 last:border-b-0 sm:border-r sm:last:border-r-0 xl:border-b-0"
            >
              <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-brand-400">Dato operativo</p>
