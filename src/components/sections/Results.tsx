...
function FeaturedCase({ c }: { c: (typeof cases)[0] }) {
  return (
    <motion.article
      ...
      className="group relative overflow-hidden rounded-2xl border bg-[#0F1117]
                 hover:shadow-[0_24px_80px_rgba(0,0,0,0.30)] transition-all duration-500"
      style={{ borderColor: `rgba(${c.accentRgb},0.20)` }}
    >
      {/* Top accent line */}
      <div className="h-0.5 w-full" style={{ background: `linear-gradient(90deg,${c.accent},rgba(167,139,250,0.3) 60%,transparent)` }} />
      ...
      <div className="p-7 lg:p-10 grid lg:grid-cols-[1fr_auto] gap-8 lg:gap-12 items-center">
        <div>
          <div className="mb-6 space-y-3">
            <div className="relative h-10 flex-shrink-0" style={{ width: c.logoW * (40 / c.logoH) }}>
              ...
              <img
                ...
                className="block invert brightness-200"
              />
            </div>
            <span
          ...
          <div className="flex flex-wrap gap-1.5">
            {c.tags.map((t) => (
              <span
                key={t}
                className="inline-flex rounded-full border border-violet-400/10
                           bg-violet-500/[0.04] px-2.5 py-0.5
        ...
        >
          ...
          <span className="mt-1.5 text-[10px] font-bold uppercase tracking-[0.18em] text-center" style={{ color: "var(--text-muted)" }}>
            {c.metricLabel}
          </span>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: `radial-gradient(ellipse 70% 50% at 0% 0%, rgba(${c.accentRgb},0.05), transparent)` }}
      />
      ...
      <div className="p-6">
        ...
        <p className="text-[2.2rem] font-black tabular-nums leading-none tracking-tight mb-1" style={{ color: c.accent }}>
          {c.metric}
        </p>
        ...
        <div className="flex flex-wrap gap-1.5">
          {c.tags.map((t) => (
            <span
              key={t}
              className="inline-flex rounded-full border border-violet-400/8
                         bg-violet-500/[0.03] px-2 py-0.5
...
export default function Results() {
  ...
  return (
    ...
    >
      {/* Section tint */}
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 bg-violet-500/[0.01]" />
      {/* Top/bottom rules */}
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute inset-x-0 top-0 h-px"
          style={{ background: "linear-gradient(90deg,transparent 10%,rgba(167,139,250,0.25) 50%,transparent 90%)" }} />
        <div className="absolute inset-x-0 bottom-0 h-px"
          style={{ background: "linear-gradient(90deg,transparent 10%,rgba(192,132,252,0.25) 50%,transparent 90%)" }} />
      </div>
      ...
      <Container>
        ...
        >
          ...
          <h2 id="results-title" className="text-3xl font-bold tracking-tight sm:text-4xl" style={{ color: "var(--text-primary)" }}>
            Proyectos reales,{" "}
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
          {kpis.map((k, i) => (
            <motion.div
              ...
              className="rounded-2xl border border-violet-400/10
                         bg-[#0F1117] p-6 text-center"
            >
              <p
              ...
              <div className="h-[3px] rounded-full bg-violet-500/[0.08] overflow-hidden">
                <motion.div
        ...
        >
          <p className="text-center text-[10px] uppercase tracking-[0.28em] font-bold text-violet-400/50 mb-8">
            Con la confianza de
          </p>
              ...
              {CAROUSEL.map((c, i) => (
                <div
                  ...
                  className="mx-10 flex items-center justify-center flex-shrink-0
                             grayscale opacity-40 invert brightness-200
